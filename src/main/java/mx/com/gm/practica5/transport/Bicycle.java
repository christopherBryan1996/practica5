...
public class Bicycle extends Land {
    ...
    public Bicycle(TypeServiceEnum typeService, double cost, String name, int whelles, String landType, String fuel, String company, int speed, int peopleCapacity, double performance, String color) {
    ...
    public String toString() {
        return "Bicycle{" + "typeService=" + typeService + ", cost=" + cost + ", name=" + name +" "+ super.toString() +'}';
    }
}
